...
keys = [
    ...
    Key([mod], "m", lazy.spawn(start_rofi),
        desc="Spawn a command using a prompt widget known as rofi"),

    # change brightness with leisure keys
    Key(["control", "shift"], "j", lazy.spawn(
        changebrightnessdown), desc="Change brightness down"),
    Key(["control", "shift"], "k", lazy.spawn(
        changebrightnessup), desc="Change brightness up"),

    Key([], "XF86MonBrightnessUp", lazy.spawn(
        "changebrightness up"), desc="Change brightness up"),
    Key([], "XF86MonBrightnessDown", lazy.spawn(
        "changebrightness down"), desc="Change brightness down"),
...
groups.append(ScratchPad("scratchpad", [
    ...
    DropDown("volume", "alacritty --class=volume -e alsamixer",
